...
categories = [('Еда и напитки', 'Еда и напитки'), ('Путешествия и туризм', 'Путешествия и туризм'), ('Здоровье и медицина', 'Здоровье и медицина'), ('Мода и стиль', 'Мода и стиль'),
              ('Технологии и интернет', 'Технологии и интернет'), ('Семья и отношения', 'Семья и отношения'), ('Искусство и культура', 'Искусство и культура'), ('Образование и карьера', 'Образование и карьера'),
              ('Спорт и фитнес', 'Спорт и фитнес'), ('Досуг и развлечения', 'Досуг и развлечения')]
